...
namespace Guaguero.Persistence.Migrations
{
    ...
    [Migration("20250402172856_nuevaMigra")]
            ...
            modelBuilder.Entity("Guaguero.Domain.Entities.Travels.Travel", b =>
                {
                    ...
                    b.Property<int>("NearestWayPointID")
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Departure = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Guaguero.Domain.Entities.Travels.Travel", b =>
                {
                    ...
                    b.HasOne("Guaguero.Domain.Entities.Logistic.Routes.WayPoint", "NearestWayPoint")
                        .WithMany()
                        .HasForeignKey("NearestWayPointID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.OwnsOne("Guaguero.Domain.Entities.Users.Credential", "Credential", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    UserBaseUserID = new Guid("a3f47c2b-1b3d-4e19-8e2a-3d9f7c5a1d5e"),
                                    Email = "example@gmail.com",
                                    PasswordHash = "a0f3285b07c26c0dcd2191447f391170d06035e8d57e31a048ba87074f3a9a15"
                                },
                                new
                                {
                                    UserBaseUserID = new Guid("d5f1a8e7-4c6b-49f2-b7d9-65e3c7f9b2a1"),
